    ...
    useEffect(() => {
        if(searchParams){
            setFormData({
                ...
                persons: searchParams.get('people'),
            ...
            <div className='container'>
                ...
                <div className='content'>
                    <div className='information'>
                        <div className='info_div booking-form'>
                            <h3>معلومات الحجز</h3>
                                            ...
                                            <div className="inputs">
                                                ...
                                                >
                                                    <div className="input">
                                                        ...
                                                        <input type="text" name='from' placeholder="من: المطار، المدينة، الفندق، الاماكن الاخري" ref={fromRef} onChange={(e) => handleInputChange(e)} defaultValue={formData.from}  />
                                                    </div>
                                                </Autocomplete>
                                                <Autocomplete
                                                    value={toPlace}
                                                ...
                                                >
                                                    <div className="input">
                                                        <i className="fa-solid fa-location-arrow"></i>
                                                        <input type="text" name='to' placeholder="الى: المطار، المدينة، الفندق، الاماكن الاخري" ref={toRef} onChange={(e) => handleInputChange(e)} defaultValue={formData.to} />
                                                    </div>
                                                </Autocomplete>
                                                <div className="inline-inputs">
                                                    <div className="input">
                                                        <i className="fa-solid fa-calendar-days"></i>
                                                        <input type="text" placeholder="التاريخ" name='date' className='datepicker' ref={dateRef} onChange={e => handleInputChange(e)} autoComplete='off' defaultValue={formData.date} />
                                                    </div>
                                                    <div className="input">
                                                        <i className="fa-regular fa-clock"></i>
                                                        <input type="text" className='timepicker' name='time' placeholder='الوقت' ref={timeRef} onChange={e => handleInputChange(e)} autoComplete='off' defaultValue={formData.time} />
                                                    </div>
                                                </div>
                                                ...
                                                <div className="inline-inputs">
                                                    <div className="input">
                                                        ...
                                                        <input type="number" placeholder="عدد الاشخاص" name='people' ref={personRef} onChange={e => handleInputChange(e)} defaultValue={formData.persons} />
                                                    </div>
                                                ...
                                                <div className={`items-container expandable ${showCars ? 'expanded' : ''}`}>
                                                    {showCars &&
                                                        cars.map((car, index) => (
                                                            ...
                                                            car.persons >= personRef.current.value && (
